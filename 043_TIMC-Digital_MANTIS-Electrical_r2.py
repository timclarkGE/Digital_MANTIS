...
class MainWindow:
    def __init__(self, master, parameters):
        ...
        self.master.title("R2 - TIMC Digital MANTIS Electrical - S/N: "+ SN)
...
class ControlFrame:
    def __init__(self, master, colorArray):
        ...
        self.left_light_scale_cam1 = Scale(camera1_frame, orient=VERTICAL, from_=0, to=0.45, resolution=0.01, command=self.update_left_intensity_cam1, bg=colorArray[7], highlightthickness=0)
        self.right_light_scale_cam1 = Scale(camera1_frame, orient=VERTICAL, from_=0, to=0.45, resolution=0.01, command=self.update_right_intensity_cam1, bg=colorArray[7], highlightthickness=0)
        ...
        self.tilt_speed_cam1 = Scale(camera1_frame, orient=HORIZONTAL, from_=0.01, to=.5, resolution=0.01, bg=colorArray[7], highlightthickness=0)
        self.pan_speed_cam1 = Scale(camera1_frame, orient=HORIZONTAL, from_=0.01, to=.5, resolution=0.01, bg=colorArray[7], highlightthickness=0)
        ...
        self.ckbx_gamepad_cam1 = Checkbutton(camera1_frame, text="Enable Gamepad", variable=self.game_pad_cam1, bg=colorArray[7], command=self.game_pad_link_cam1)
        ...
        self.tilt_speed_cam2 = Scale(camera2_frame, orient=HORIZONTAL, from_=0.01, to=.5, resolution=0.01, highlightthickness=0, bg=colorArray[8])
        self.pan_speed_cam2 = Scale(camera2_frame, orient=HORIZONTAL, from_=0.01, to=.5, resolution=0.01, highlightthickness=0, bg=colorArray[8])
        ...
        self.ckbx_gamepad_cam2 = Checkbutton(camera2_frame, text="Enable Gamepad", variable=self.game_pad_cam2, bg=colorArray[8], command=self.game_pad_link_cam2)
