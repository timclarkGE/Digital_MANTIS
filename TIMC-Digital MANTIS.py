...
class MainWindow:
    def __init__(self, master, parameters):
        ...
        self.out1 = PnematicControlFrame(self.master, blue_checkers)
...
class PnematicControlFrame:
    def __init__(self, master, colorArray):
        ...
        out1 = PnematicFrame(frame1, "Channel #1", colorArray[0])
        out2 = PnematicFrame(frame2, "Channel #2", colorArray[1])
        out3 = PnematicFrame(frame3, "Channel #3", colorArray[2])
        out4 = PnematicFrame(frame4, "Channel #4", colorArray[3])
        out5 = PnematicFrame(frame5, "Channel #5", colorArray[4])
        out6 = PnematicFrame(frame6, "Channel #6", colorArray[5])
        out7 = PnematicFrame(frame7, "Channel #7", colorArray[6])
        out8 = PnematicFrame(frame8, "Channel #8", colorArray[7])
        out9 = PnematicFrame(frame9, "Channel #9", colorArray[8])
        out10 = PnematicFrame(frame10, "Channel #10", colorArray[9])
