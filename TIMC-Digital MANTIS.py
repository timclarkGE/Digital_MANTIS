...
class ControlFrame:
    def __init__(self, master, colorArray):
        ...
        self.power.setDeviceSerialNumber(538798)
        ...
        self.manual_select.setDeviceSerialNumber(538798)
        ...
        self.near.setDeviceSerialNumber(538798)
        ...
        self.far.setDeviceSerialNumber(538798)
        ...
        self.wide.setDeviceSerialNumber(538798)
        ...
        self.tele.setDeviceSerialNumber(538798)
        ...
        self.left_light.setDeviceSerialNumber(538798)
        ...
        self.right_light.setDeviceSerialNumber(538798)
        ...
        self.pan.setDeviceSerialNumber(538798)
        ...
        self.tilt.setDeviceSerialNumber(538798)
